...
set(BASE_FLAGS "-march=native")
set(CXX_FLAGS "-O3 ${BASE_FLAGS}")
set(C_FLAGS "-O3")
set(CUDA_NVCC_FLAGS  "${BASE_FLAGS}")
...
option(MFEM_USE_CUDA "Enable CUDA" ON)
...
set(CUDA_ARCH "sm_120" CACHE STRING "Target CUDA architecture.")
...
set(METIS_DIR "/usr/local/" CACHE PATH "Path to the METIS library.")
...
set(ParMETIS_DIR "/usr/local/" CACHE PATH
