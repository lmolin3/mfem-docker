...
set(BASE_FLAGS "-Wall")
set(CXX_FLAGS "-O0 -gdwarf-4 -mno-avx512f ${BASE_FLAGS}")
set(C_FLAGS "-O0 -gdwarf-4 -mno-avx512f ${BASE_FLAGS}")
...
set(METIS_DIR "/usr/x86_64-linux-gnu/" CACHE PATH "Path to the METIS library.")
...
# If MFEM_USE_PETSC is ON, but compiler is not mpicc, then set(PETSC_EXECUTABLE_RUNS "ON") 
if (MFEM_USE_PETSC AND NOT CMAKE_C_COMPILER MATCHES "mpicc")
