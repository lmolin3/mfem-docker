...
# Set build type to debug and define 
set(CMAKE_BUILD_TYPE "RELEASE")
message("Building MFEM mode using default setting ${CMAKE_BUILD_TYPE}")

# Setting extra compiler flags according to build type.
set(CMAKE_C_COMPILER "/usr/bin/mpicc")
set(CMAKE_CXX_COMPILER "/usr/bin/mpicxx")
set(BASE_FLAGS "-march=native -fcolor-diagnostics -fvectorize -fslp-vectorize -ffp-contract=fast")
set(CXX_FLAGS "-O3 -funroll-loops -flto -Wno-inconsistent-missing-override ${BASE_FLAGS}")
set(C_FLAGS "-O3 -funroll-loops -flto -Wno-inconsistent-missing-override ${BASE_FLAGS}")
message("Compiling with CXX flags: ${CXX_FLAGS}")
...
set(HYPRE_DIR "/opt/hypre-2.31.0" CACHE PATH
...
set(MUMPS_DIR "/usr/local" CACHE PATH
...
# v2.2.0.
set(Scotch_DIR "/usr/local/" CACHE PATH
...
set(HDF5_DIR "/usr/local" CACHE PATH "Path to the HDF5 library.")
set(NETCDF_DIR "/usr/local" CACHE PATH "Path to the NetCDF library.")
set(NetCDF_REQUIRED_PACKAGES "HDF5/C/HL" CACHE STRING
    "Additional packages required by NetCDF.")

#if (MFEM_USE_PETSC)
# For some reasons PETSC complains about this variable missing
#   set(PETSC_EXECUTABLE_RUNS "ON")  
#endif()
set(PETSC_DIR "/usr/local" CACHE PATH    "Path to the PETSc main directory.")
set(PETSC_ARCH "" CACHE STRING "PETSc build architecture.")

set(SLEPC_DIR "/usr/local" CACHE PATH
...
set(LAPACK_INCLUDE_DIRS "/usr/include/x86_64-linux-gnu" CACHE STRING "Path to LAPACK headers.")
set(LAPACK_LIBRARIES "/usr/lib/x86_64-linux-gnu/libopenblas.so" CACHE STRING "The LAPACK library.")
...
# Enzyme setup
set(ENZYME_DIR "/opt/archives/Enzyme/enzyme/build" CACHE PATH "Path to Enzyme")
